...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(epe-pipeline-delimiter-face ((,class (:foreground ,alum-1))))
   `(epe-pipeline-host-face ((,class (:foreground ,alum-1))))
   `(epe-pipeline-user-face ((,class (:foreground ,alum-1))))
   `(epe-pipeline-time-face ((,class (:foreground ,alum-1))))
