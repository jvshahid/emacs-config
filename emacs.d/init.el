...
(when (display-graphic-p)
  ...
  (push '([?\M-d] . [C-S-right C-x]) exwm-input-simulation-keys)
  ...
  (setq exwm-input-simulation-keys
        (remove `(,(kbd "C-k") . [S-end delete]) exwm-input-simulation-keys))
  (push `(,(kbd "C-k") . [S-end C-x delete]) exwm-input-simulation-keys)
  (push `(,(kbd "C-y") . [C-v]) exwm-input-simulation-keys)
  (push `(,(kbd "C-w") . [C-x]) exwm-input-simulation-keys)
  (push `(,(kbd "M-w") . [C-c]) exwm-input-simulation-keys)
  (push `(,(kbd "C-c C-w") . [S-C-left C-x]) exwm-input-simulation-keys)
  (push `([?\C-  ?\C-n] . [S-down]) exwm-input-simulation-keys)
  (push `([?\C-  ?\C-p] . [S-up]) exwm-input-simulation-keys)
  (push `([?\C-  ?\M-f] . [S-C-right]) exwm-input-simulation-keys)
  (push `([?\C-  ?\M-b] . [S-C-left]) exwm-input-simulation-keys)
  (push `([?\C-  ?\C-a] . [S-home]) exwm-input-simulation-keys)
  (push `([?\C-  ?\C-e] . [S-end]) exwm-input-simulation-keys)
  (push `([?\C- ?\M-<] . [S-C-home]) exwm-input-simulation-keys)
  (push `([?\C- ?\M->] . [S-C-end]) exwm-input-simulation-keys)
